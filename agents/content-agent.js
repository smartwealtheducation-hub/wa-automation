...
// Fetch existing WordPress categories so we can assign the article to a
// real one instead of it defaulting to "Uncategorized".
...
// Ask the LLM to pick the single best-fitting EXISTING category (never
// invent a new one) based on the article's topic.
